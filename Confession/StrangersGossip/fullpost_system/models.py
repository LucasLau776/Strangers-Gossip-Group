...
class CommentReport(models.Model):
    ...
    reporter_session_key = models.CharField(max_length=40, null=True, blank=True)
...
class Notification(models.Model):
    ...
    sender_session_key = models.CharField(max_length=40, null=True, blank=True)
    ...
    def __str__(self):
        return f"{self.get_notification_type_display()} - {self.recipient_session_key}"