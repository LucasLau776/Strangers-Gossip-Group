...
from .models import SessionIdentity, Post, Comment, PostLike, CommentLike, Reply, ReplyLike, PostSave, PostReport, CommentReport
...
class CommentReportAdmin(admin.ModelAdmin):
    list_display = ['id', 'comment', 'session_key', 'reason', 'created_at']
